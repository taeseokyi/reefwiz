...
A re-run of the null on the same aged aliquot a day later showed the offset
decaying from $-0.06$ to $-0.22\dkh$ with the electronics untouched, confirming
the attribution in the time domain.
